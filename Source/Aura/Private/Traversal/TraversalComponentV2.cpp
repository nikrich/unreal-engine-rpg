...
#include <Traversal/TraversalComponentV2.h>
#include "GameFramework/CharacterMovementComponent.h"
#include "Components/CapsuleComponent.h"


UTraversalComponentV2::UTraversalComponentV2()
{
	PrimaryComponentTick.bCanEverTick = false;
}


void UTraversalComponentV2::BeginPlay()
{
	Super::BeginPlay();
...
FTraversalInputType UTraversalComponentV2::GetTraversalInput() const
{
...
void UTraversalComponentV2::PerformTraversalTrace()
{
	TraversalCheckResult = FTraversalCheckResult();

	// TODO get traversable block from collision object
...
FTraversableBlockResult UTraversalComponentV2::CheckIfObjectIsTraversable() const
{
	...
	// TODO - Implement a way to check if the object is traversable using the object's collision object.
...
void UTraversalComponentV2::SetBackFloorInfo(FTraversalCheckResult& CheckResult)
{
...
FTraversalChooserInputs UTraversalComponentV2::MakeChooserInputs() const
{
